  ...
  return (
    <View style={styles.mainContainer}>
      <ScrollView contentContainerStyle={Layout.fillGrow}>
        <View style={[row, regularHPadding, alignItemsCenter, justifyContentBetween, { backgroundColor: Colors.primary, height: 70 }]}>
          <TouchableOpacity onPress={() => props.navigation.goBack()}>
            <Image source={Images.whiteBackArrow} style={{ width: 30, height: 20, resizeMode: 'contain' }} />
          </TouchableOpacity>
        ...
        <View style={[styles.cardStyle, regularVPadding]}>
          ...
          <View style={[row, regularHMargin, justifyContentBetween, alignItemsCenter, smallVPadding, Global.borderB, Global.borderAlto]}>
          ...
          <View style={[row, regularHMargin, justifyContentBetween, alignItemsCenter, smallVPadding]}>
            <Text text="Fats" bold />
            <View style={[row, regularHMargin, Gutters.smallTMargin]}>
              <View style={[row, justifyContentStart, alignItemsStart]}>
