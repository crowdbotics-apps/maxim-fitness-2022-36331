  ...
  return (
    <>
      ...
      >
        <View style={[fill, justifyContentAround, mediumHMargin]}>
          <View style={[row, alignItemsCenter]}>
            ...
            <Text text={'Modal description'} color="secondary" style={{ fontSize: 16 }} />
          </View>
          {/* <View style={[row, alignItemsCenter]}>
        ...
        <View style={[row, center, fill, mediumTMargin]}>
          <Text
            text={`$ ${getPlans?.length > 0 ? getPlans && getPlans[0]?.amount : '0'}`}
            regularTitle
            color="secondary"
            bold
            center
        ...
        {getPlans && getPlans[0]?.id === subsucriptionId ? (
      ...
      <View style={[center, row, { marginTop: -20, backgroundColor: 'transparent' }]}>
        <Button
          color="secondary"
          text={getPlans && getPlans[0]?.id === subsucriptionId ? 'Already Bought' : 'Buy Now'}
