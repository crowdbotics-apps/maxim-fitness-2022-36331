...
const FatLoseProgramV2 = props => {
  ...
  return (
    <SafeAreaView style={[fill, { backgroundColor: 'white' }]}>
      ...
      {/* bootom */}
      <BottomSheet reff={refDescription} h={200} Iconbg={"white"} bg={"white"}
       customStyles={{
        ...
        >
          <View style={[regularHMargin, {}]}>
            <View style={[row,alignItemsCenter]}>
              ...
              <Text
                text={`View Workout`}
                style={{ fontSize: 20, lineHeight: 18, fontWeight: 'bold', opacity: 0.7,color:"black",marginLeft:50 }}
              />
            </View>
...
export default FatLoseProgramV2;
