...
class SearchablePaginatedList extends Component {
  ...
  reloadList = async () => {
    const { fetchListAction, search, filter } = this.props;
  ...
  render() {
    ...
    const { appending, loading, hasMore, userRefreshing } = this.state;
      ...
      <SafeAreaView style={style}>
        <PaginatedListContainer
          ...
          refreshListToInitial={() =>
            this.setState({ ...initialState, loading: false }, () => this.reloadList())
          }
